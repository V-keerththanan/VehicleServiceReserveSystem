...
<body>
    ...
    <div class="services-list">
        ...
        <ul>
            <!-- Dummy list items for demonstration purposes -->
            <li>Service 1 <button class="delete-service">Delete</button></li>
            <li>Service 2 <button class="delete-service">Delete</button></li>
            <li>Service 3 <button class="delete-service">Delete</button></li>
        </ul>
    </div>
</body>
</html>
